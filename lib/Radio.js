...
module.exports = React.createClass({
  ...
  prefixClsFn: function() {
        var prefixCls = this.props.prefixCls || 'rc';
  ...
  render: function () {
    ...
    var options = this.props.options.map(function (option, index) {
      var className = prefixClsFn('radio', (self.state.focusIndex === index ? prefixClsFn(focusClassName) : ''));
      return (
    ...
    return (
      <div className={prefixClsFn('radio-group')}>
          {options}
      </div>
    );
  }
